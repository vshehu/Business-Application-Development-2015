...
Public Class frmIncomingTransaction
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim sql As String
        sql = "INSERT INTO Transactions(transaction_date, category, description, amount, transaction_type) VALUES(@td, @cat, @descr, @amnt, 'income')"
        ...
        If MessageBox.Show("Do you want to register a new income?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Me.Close()
        Else
            txtAmount.Clear()
